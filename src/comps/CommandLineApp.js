...
const CommandLineApp = ({
  ...
  const [currentTerminalDirectory, setCurrentTerminalDirectory] =
    useState("rahul@fakeWindows(Linux)");
  ...
  const onKeydownTerminalInput = (e) => {
    if (e.key === "Enter") {
      ...
      if (command === "linkedin") {
        window.open(
          "https://linkedin.com/in/mistryrahul",
          "_blank",
          WIN_FEATURES
        );
      ...
      if (command === "whatsapp") {
        const textMessage = encodeURIComponent(
          "Hello Rahul Mistry!, [your message here]"
        );
        window.open(
          `https://wa.me/+919558353148?text=${textMessage}`,
          "_blank",
          WIN_FEATURES
        );
      ...
      >
        ...
        <div className="h-full px-2 pb-10 overflow-scroll ">
          <p className="mb-2">
            ...
            (c) Rahul Mistry. All rights reserved
          </p>
          <p className="my-1">
